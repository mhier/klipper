...
class DRV8711:
  ...
  def handle_connect(self):
    ...
    # See: www.ti.com/product/DRV8711/datasheet/detailed-description#SLVSC405764
    reg0 = 0xC01;  # 11YY 0XXX X001: ENBL = 1, RDIR = 0, RSTEP = 0, MODE = XXXX,
                   # EXSTALL = 0, ISGAIN = YY, DTIME = 11
    ...
    reg6 = 0x0F0 # 0000 1111 0000: OCPTH = 00, OCPDEG = 00, TDRIVEN = 11,
                 # TDRIVEP = 11, IDRIVEN = 00, IDRIVEP = 00
    reg7 = 0x000 # 0000 0000 0000: OTS = 0, AOCP = 0, BOCP = 0, UVLO = 0,
                 # APDF = 0, BPDF = 0, STD = 0, STDLAT = 0
